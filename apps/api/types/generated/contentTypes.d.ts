...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gaspFactor: Attribute.Component<'review.gasp-factor'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    relatedReviews: Attribute.Relation<
      'api::review.review',
      'oneToMany',
      'api::review.review'
    >;
...
export interface ApiSiteInfoSiteInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    navLinks: Attribute.Component<'general.link', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footerLinkColumns: Attribute.Component<'general.footer-links', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
